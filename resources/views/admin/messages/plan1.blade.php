...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Главная</a>> <a href="#" class="current">План №1</a> </div>
    <h1>Добавить сообщения ПЛАН №1</h1>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/admin/addMsg1') }}" name="add_plan1" id="add_plan1" novalidate="novalidate">{{ csrf_field()}}
